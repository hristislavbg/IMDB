CREATE DATABASE  IF NOT EXISTS `imdb-2` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `imdb-1`;
-- MySQL dump 10.13  Distrib 8.0.26, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: imdb-1
-- ------------------------------------------------------
...
CREATE TABLE IF NOT EXISTS `user_movie` (
  ...
  `movie_id` bigint NOT NULL,
  KEY `FKr6sat9q5ucem7a4g6ghxtcb59` (`movie_id`),
  KEY `FKqd5rgwryq7nur31kqc92ww09o` (`user_id`),
  CONSTRAINT `FKqd5rgwryq7nur31kqc92ww09o` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`),
  CONSTRAINT `FKr6sat9q5ucem7a4g6ghxtcb59` FOREIGN KEY (`movie_id`) REFERENCES `movies` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
-- Dump completed on 2021-10-10 13:16:56
